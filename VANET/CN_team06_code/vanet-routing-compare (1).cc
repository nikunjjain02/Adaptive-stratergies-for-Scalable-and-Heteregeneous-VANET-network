...
VanetRoutingExperiment::SetupScenario ()
{
  ...
  if (m_scenario == 1)
    ...
    {
      // Realistic vehicular trace in 4.6 km x 3.0 km bangalore kr circle
      // "low density, 190 total vehicles"
      m_traceFile = "/home/codebind/mobilityf.tcl";
      m_logFile = "mobpriyanshu.log";
      m_mobility = 1;
      m_nNodes = 180;
      m_TotalSimTime = 30.01;
      m_nodeSpeed = 10;
      m_nodePause = 0;
      m_CSVfileName = "mobpriyanshu.csv";
      m_CSVfileName = "mobpriyanshu2.csv";
    }
}
